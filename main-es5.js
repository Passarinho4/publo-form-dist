...
var ButtonComponent = /** @class */ (function () {
    ...
    ButtonComponent.prototype.add = function (event) {
        var input = event.input;
        var value = event.value.toLowerCase().normalize("NFD")
            .replace(/[\u0300-\u036f]/g, "")
            .replace(/ł/g, "l");
        if ((value || '').trim() && value !== "#") {
    ...
    ButtonComponent.prototype.remove = function (fruit) {
...
var CreatorStepComponent = /** @class */ (function () {
    function CreatorStepComponent() {
    }
    CreatorStepComponent.prototype.ngOnInit = function () {
    };
...
var PubloFooterComponent = /** @class */ (function () {
    function PubloFooterComponent() {
    }
    PubloFooterComponent.prototype.ngOnInit = function () {
    };
...
var PubloHeaderComponent = /** @class */ (function () {
    function PubloHeaderComponent() {
    }
    PubloHeaderComponent.prototype.ngOnInit = function () {
    };
